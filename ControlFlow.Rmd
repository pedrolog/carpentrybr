...
<input type=button id=toggle_d7 value="Resposta do desafio 2"></input>
...
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d7").on( "click", function(){
  ...
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d7").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
} );
</script>

***

<input type=button id=toggle_d1 value="Desafio 3"></input>
...
<input type=button id=toggle_d2 value="Resposta do desafio 3"></input>
...
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().hide();
$("#toggle_d2").on( "click", function(){
  ...
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
  $("#toggle_d2").parent().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().toggle();
} );
</script>

***

<input type=button id=toggle_d3 value="Desafio 4"></input>
...
<input type=button id=toggle_d4 value="Resposta do desafio 4"></input>
...
<input type=button id=toggle_d5 value="Desafio 5 - Avançado"></input>
...
<input type=button id=toggle_d6 value="Resposta do desafio 5"></input>
...
$("#toggle_d6").parent().next().next().next().next().next().hide();
$("#toggle_d6").parent().next().next().next().next().next().next().hide();
$("#toggle_d6").on( "click", function(){
  ...
  $("#toggle_d6").parent().next().next().next().next().next().toggle();
  $("#toggle_d6").parent().next().next().next().next().next().next().toggle();
 } );
</script>
