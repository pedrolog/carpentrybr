...
knitr_fig_path("07-")
# Faça o carregamento dos dados para que os restantes das lições funcionem
gapminder <- read.csv("data/gapminder-FiveYearData.csv", header=TRUE)
# Coloque uma semente para geração de número aleatórios, dessa forma não precisaremos explicar isto.
set.seed(10)
```
